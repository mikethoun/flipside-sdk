...
class QueryRunStats(BaseModel):
    started_at: datetime | None = Field(None, description="The start time of the query run.")
    ended_at: datetime | None = Field(None, description="The end time of the query run.")
    query_exec_started_at: datetime | None = Field(
        None, description="The start time of query execution."
    )
    query_exec_ended_at: datetime | None = Field(
        None, description="The end time of query execution."
    )
    streaming_started_at: datetime | None = Field(
        None, description="The start time of streaming query results."
    )
    streaming_ended_at: datetime | None = Field(
    ...
    streaming_seconds: int | None = Field(
        None,
    ...
    query_exec_seconds: int | None = Field(
        None,
    ...
    bytes: int | None = Field(None, description="The number of bytes returned by the query.")
